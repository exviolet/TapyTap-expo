    ...
    return (
        <Tab.Navigator
            screenOptions={{
                ...
                tabBarStyle: {
                    ...
                    height: 90, // Стандартная высота для современных телефонов
                },
                tabBarLabelStyle: {
                    fontSize: 12,
                    paddingBottom: 10,
        ...
        >
            ...
            <Tab.Screen name="AddHabitTab" component={AddHabitScreen} options={{
                ...
                tabBarLabel: () => null, // Скрываем текст под кнопкой
            }}
            listeners={{
                tabPress: e => {
                    e.preventDefault();
                    navigation.navigate('AddHabitModal'); // Открываем модально
                }
            }}
            />
